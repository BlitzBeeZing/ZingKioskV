...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private String amountString = "1.00";
...
//        });
    ...
    private void run() throws IOException {
        ...
        String apiKey = "28ECB1DE1DD4BFDB5D69081E8932F7";  //Put your API Key Here
        String clientId = "zingnow";  // Put your clientID here
        String merchantId = "zingnow";   // Put your merchant ID here
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try{
                    ...
                    CheckoutActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(CheckoutActivity.this, "Starting Start Payment", Toast.LENGTH_SHORT).show();
