...
//        });
    ...
    private void initiatePaymentsSDK() {
        if(!hyperServicesHolder.isInitialised()){
            ...
            //Showing snackbar
//            ThemedSpinnerAdapter.Helper helper = new ThemedSpinnerAdapter.Helper();
...
//            helper.showSnackbar("Initiate Called!", coordinatorLayout);
    ...
    private JSONObject createInitiatePayload() {
        ...
        try {
            ...
            innerPayload.put("merchantId", "zingnow");    // Put your Merchant ID here
            innerPayload.put("clientId", "zingnow");          // Put your Client ID here
